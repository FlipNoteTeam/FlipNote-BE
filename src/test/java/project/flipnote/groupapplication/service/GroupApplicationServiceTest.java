...
class GroupApplicationServiceTest {
	...
	void 그룹_가입_신청() throws Exception {
	    //given
		GroupApplicationJoinRequest.Request req = new GroupApplicationJoinRequest.Request("가입신청123");

	    //when
		GroupApplicationJoinRequest.Response res = groupApplicationService.joinRequest(1L, 1L, req);
		GroupApplicationJoinRequest.Response secRes = groupApplicationService.joinRequest(1L, 1L, req);
