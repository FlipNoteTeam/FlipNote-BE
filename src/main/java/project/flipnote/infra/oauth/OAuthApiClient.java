package project.flipnote.infra.oauth;
...
import project.flipnote.infra.oauth.model.GoogleUserInfo;
...
public class OAuthApiClient {
	...
	public OAuth2UserInfo createUserInfo(String providerName, Map<String, Object> userInfoAttributes) {
		return switch (providerName.toLowerCase()) {
			case "google" -> new GoogleUserInfo(userInfoAttributes);
