...
public enum GroupJoinErrorCode implements ErrorCode {
    ...
    NOT_EXIST_JOIN(HttpStatus.NOT_FOUND, "GROUP_JOIN_004", "가입 신청이 존재하지 않습니다."),
    ALREADY_JOINED_GROUP(HttpStatus.CONFLICT, "GROUP_JOIN_005", "이미 신청한 그룹입니다."),
    GROUP_IS_ALREADY_MAX_MEMBER(HttpStatus.CONFLICT, "GROUP_JOIN_006", "그룹 정원이 가득 찼습니다.");
